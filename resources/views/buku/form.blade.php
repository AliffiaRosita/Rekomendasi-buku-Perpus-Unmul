...
<div class="row mb-5">
    <div class="col-6">
        ...
        <div class="row">
            <div class="col">
            <div id='img_contain'>
            <img id="img" src="{{isset($book->foto)? asset("image/buku/".$book->foto): "http://www.clker.com/cliparts/c/W/h/n/P/W/generic-image-file-icon-hi.png"}}" height="200px" width="100px"
